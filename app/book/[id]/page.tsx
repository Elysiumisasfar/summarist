...
export default function IndividualBookPage() {
  ...
  if (loading) return <div style={{ padding: "40px", marginLeft: "280px" }}>Loading single item architecture view...</div>;
  if (!book) return <div style={{ padding: "40px", marginLeft: "280px" }}>Book item asset profile not located.</div>;

  return (
    <div style={{ display: "flex" }}>
      <Sidebar />
      <div style={{ marginLeft: "280px", padding: "40px", flexGrow: 1, maxWidth: "1000px" }}>
