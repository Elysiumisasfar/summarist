...
// 1. Declare that this component expects a modal trigger function
interface ReviewsProps {
  onAuthOpen: () => void;
}

// 2. Pass the prop into your functional component argument definition
const Reviews: React.FC<ReviewsProps> = ({ onAuthOpen }) => {
  return (
    <section id="reviews">
      <div className="row">
        <div className="container">
          ...
          <div className="reviews__btn--wrapper">
            {/* 3. Attach the trigger function right here! */}
